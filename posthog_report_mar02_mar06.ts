...
const afterDate = "2026-03-02T00:00:00Z";
const beforeDate = "2026-03-06T23:59:59Z";
...
async function run() {
    console.log("Extrayendo datos de PostHog del 02 al 06 de Marzo 2026...\n");
    ...
    // Excluir pruebas
    const correosDePrueba = ['juanmartinez@gfs.es', 'sdasda@asddsa.com'];
    for (const [id, u] of usersMap.entries()) {
        if (u.email && correosDePrueba.includes(u.email.toLowerCase())) {
            usersMap.delete(id);
        }
    }
    ...
    usersMap.forEach(u => {
        ...
        const detail: any = {
            ...
            stage,
            hora: new Date(u.last_seen).toLocaleString('es-ES', { day: '2-digit', month: '2-digit', hour: '2-digit', minute: '2-digit' })
        };
        ...
        // Track the max step for details
        if (u.click_start && !u.completed) {
            const maxStep = u.steps_seen.size > 0 ? Math.max(...u.steps_seen) : 0;
            detail.abandoned_at = maxStep;
        }
    ...
    const lines: string[] = [
        `╔══════════════════════════════════════════════════════════════╗`,
        `║    📊 INFORME SEMANAL - LANDING FUNNEL GFS CONSULTING      ║`,
        `║    📅 Fecha: Del 02 al 06 de Marzo de 2026                 ║`,
        ...
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`,
        ``,
        `  👥 Usuarios únicos totales:                 ${totalUsers}`,
        ``,
        `  👀 Nivel 1 - Vieron landing (rebote):       ${n1} usuarios`,
        `  ⚠️  Nivel 2 - Iniciaron y abandonaron:       ${n2} usuarios`,
        `  📋 Nivel 3 - Finalizaron (sin agendar):     ${n3} usuarios`,
        `  ✅ Nivel 4 - Finalizaron + Agendaron:       ${n4} usuarios`,
        ``,
        `  📊 Tasas de Conversión:`,
        `     Vieron → Iniciaron encuesta: ${landingToStart}% (${n2 + n3 + n4} de ${n1 + n2 + n3 + n4})`,
        `     Iniciaron → Finalizaron:     ${startToComplete}% (${n3 + n4} de ${n2 + n3 + n4})`,
        `     Finalizaron → Agendaron:      ${completeToBook}% (${n4} de ${n3 + n4})`,
        ``
    ];

    lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    lines.push(`  🏚️  DÓNDE ABANDONARON LOS USUARIOS (NIVEL 2)`);
    lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    lines.push(``);
    if (Object.keys(abandonedStepsCount).length === 0) {
        lines.push(`  Ningún usuario abandonó la encuesta a medias.`);
    } else {
        Object.entries(abandonedStepsCount)
            .sort((a, b) => parseInt(a[0]) - parseInt(b[0]))
            .forEach(([step, count]) => {
                if (step === "0") {
                    lines.push(`  - Abandonaron sin ver ninguna pregunta (paso 0): ${count} usuarios`);
                } else {
                    lines.push(`  - Abandonaron en el paso ${step}/8: ${count} usuarios`);
                }
            });
    }
    lines.push(``);
    ...
    if (capturedLeads.length > 0) {
        lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
        lines.push(`  📧 LEADS CAPTURADOS DE LA SEMANA`);
        lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
        lines.push(``);
    ...
    lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    lines.push(`  📈 EVENTOS CUSTOM DE LA SEMANA`);
    lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    lines.push(``);
    ...
    const outputFile = 'c:\\Users\\JuanMartínezCarrillo\\Desktop\\TRABAJOS\\Landing Funnel\\informe_semana_02_al_06_marzo.txt';
